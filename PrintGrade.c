...
void main()
{
  char Name[30][40] = {"ball cpe", "Mary McBeth", "Ying Phakpon","Chai Chanchai", "Yong Boonsith", "Kitti Karndee"}; 
  int ID[30] = {778899, 5302, 5303, 5304, 5305, 5306}; 
  float GPA[30] = {5.00, 2.35, 3.65, 3.24, 1.32, 3.26}; 
  int N = 6, i;
